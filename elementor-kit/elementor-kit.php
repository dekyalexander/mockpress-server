...
class MockPress_Kit {
	...
	public function editor_scripts() {
		...
		wp_enqueue_script(
			'mockpress-editor',
			MOCKPRESS_URL . 'elementor-kit/assets/js/editor.js',
			array( 'jquery', 'underscore', 'backbone-marionette' ),
			'1.0.0',
			true
		);

		wp_localize_script( 'mockpress-editor', 'LandingPressKitData', apply_filters(
	...
	public function editor_styles() {
		...
		wp_enqueue_style(
			'mockpress-editor',
			MOCKPRESS_URL . 'elementor-kit/assets/css/editor.css',
			array(),
			'1.0.0'
		);
	...
	public function print_templates() {
		...
		foreach ( glob( MOCKPRESS_PATH . 'elementor-kit/templates/*.php' ) as $file ) {
			include_once( $file );
		}
	...
	public function preview_styles() {
		...
		wp_enqueue_style(
			'mockpress-preview',
			MOCKPRESS_URL . 'elementor-kit/assets/css/preview.css',
			array(),
			'1.0.0'
		);
	...
	public static function get_info_data( $mode = 'elementor', $force_update = false ) {
